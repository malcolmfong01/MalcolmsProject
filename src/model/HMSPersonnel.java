...
/**
 * Represents a personnel in the Hospital Management System (HMS).
...
public class HMSPersonnel {
    ...
    /**
     * Constructs a new HMSPersonnel object with the specified details.
     * 
     * @param UID the unique ID for the personnel
     * @param fullName the full name of the personnel
     * @param idCard the identification card number of the personnel
    ...
    /**
     * Gets the ID card number of the personnel.
     * 
     * @return the ID card number of the personnel
     */
    ...
    /**
     * Sets the ID card number for the personnel.
     * 
     * @param idCard the ID card number to set
     */

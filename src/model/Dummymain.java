...
public class Dummymain {
        ...
        public static void main(String[] args) {
                ...
                Medicine med1 = new Medicine("M001", "Paracetamol", "ABC Pharmaceuticals",
                                LocalDateTime.of(2025, 6, 30, 0, 0), 100, 20, 10, ReplenishStatus.NULL,
                                LocalDateTime.of(2023, 12, 1, 0, 0), LocalDateTime.of(1, 1, 1, 0, 0));

                Medicine med2 = new Medicine("M002", "Ibuprofen", "XYZ Pharma",
                                LocalDateTime.of(2024, 8, 15, 0, 0), 50, 10, 10, ReplenishStatus.NULL,
                                LocalDateTime.of(2023, 11, 20, 0, 0), LocalDateTime.of(1, 1, 1, 0, 0));
                ...
                Pharmacist pharm3 = new Pharmacist("Charlie Wong", "S3456789C", "charlie.wong",
                                "charlie@example.com", "34567890", "passwordHash3",
                                LocalDateTime.of(1990, 11, 25, 0, 0),
                ...
                AppointmentOutcomeRecord outcomeRecord1 = new AppointmentOutcomeRecord("AOR01",
                                "P001", "Dr001", "D001", LocalDateTime.now().minusDays(2),
                                prescription1, "General Consultation", "Patient advised on medication usage.",
                                AppointmentOutcomeStatus.COMPLETED);

                AppointmentOutcomeRecord outcomeRecord2 = new AppointmentOutcomeRecord("AOR01",
                                "P001", "Dr002", "D002", LocalDateTime.now().minusDays(1),

...
/**
 * The RescheduleAppointmentBoundary class provides functionality to reschedule
 * appointments for a patient. It allows users to view confirmed appointments
 * and select available slots for rescheduling.
 */
public class RescheduleAppointmentBoundary extends Boundary {

	private Patient patient;
    /**
     * Constructs a RescheduleAppointmentBoundary instance with the given patient.
     *
     * @param patient The patient using this UI to reschedule appointments.
     */
	public RescheduleAppointmentBoundary(Patient patient) {
	...
	public void rescheduleAppointment() {
		...
		while (true) {
			if (!Validator.promptConfirmation("reschedule appointment")) {
				break;
			}

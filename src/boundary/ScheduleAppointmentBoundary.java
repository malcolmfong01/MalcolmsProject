...
/**
 * The ScheduleAppointmentBoundary class provides an interface for patients to schedule
 * appointments with doctors, offering functionality to input availability and
 * display scheduled appointments.
 */
public class ScheduleAppointmentBoundary extends Boundary {

	private Patient patient;
    /**
     * Constructor to initialize the ScheduleAppointmentBoundary with the given patient.
     *
     * @param patient The patient using this UI.
     */
	public ScheduleAppointmentBoundary(Patient patient) {
	...
	public void scheduleAppointment() {
		...
		while (true) {
			if (!Validator.promptConfirmation("schedule appointment")) {
				break;
			}
